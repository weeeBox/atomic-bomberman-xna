...
namespace BomberEngine
{
    ...
    public class KeyCodeHelper
    {
        ...
        private static readonly NameBinding[] nameBindings = 
        {
            ...
            new NameBinding("ESC", KeyCode.Escape),
            new NameBinding("PGUP", KeyCode.PageUp),
            new NameBinding("PGDN", KeyCode.PageDown),
            ...
            new NameBinding("INS", KeyCode.Insert),
            new NameBinding("DEL", KeyCode.Delete),
            ...
            new NameBinding("+", KeyCode.OemPlus),
            new NameBinding(",", KeyCode.OemComma),
            new NameBinding("-", KeyCode.OemMinus),
            new NameBinding("PERIOD", KeyCode.OemPeriod),
            new NameBinding("?", KeyCode.OemQuestion),
            new NameBinding("~", KeyCode.OemTilde),
            new NameBinding("[", KeyCode.OemOpenBrackets),
            new NameBinding("]", KeyCode.OemCloseBrackets),
